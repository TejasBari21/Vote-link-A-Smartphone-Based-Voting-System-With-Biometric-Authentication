...
import { Camera, Volume2, Eye, Armchair as Wheelchair, LogOut, CheckCircle, AlertCircle, MapPin, ArrowLeft, Clock, AlertTriangle, LayoutDashboard, Blocks } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen p-3 sm:p-4 pt-16 pb-6 overflow-x-hidden">
      ...
      <div className="bg-black/5 backdrop-blur-lg border border-black/20 rounded-2xl p-3 mb-4 max-w-7xl mx-auto">
        <div className="flex flex-wrap gap-2 sm:gap-3 items-center justify-center">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-purple-500/20 text-purple-700 border border-purple-500/30 rounded-lg hover:bg-purple-500/30 hover:text-purple-900 transition-all duration-300 text-sm"
      ...
      {showBlockchainExplorer && (
        <BlockchainExplorer
          isVisible={showBlockchainExplorer}
