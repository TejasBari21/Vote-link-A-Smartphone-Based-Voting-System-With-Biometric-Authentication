      ...
      <div className="fixed inset-0 z-[80] overflow-y-auto">
        ...
        <div className="min-h-screen flex items-center justify-center p-4 py-10 relative">
          <div className="w-full max-w-lg">
            ...
            {/* ── Action buttons ── */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 s3-f3 relative z-20">
              <button
                onClick={handleViewEtherscan}
                className="s3-btn min-h-[48px] flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-semibold text-center leading-tight"
                style={{
              ...
              <button
                ...
                className="s3-btn min-h-[48px] flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-semibold text-center leading-tight disabled:opacity-60 disabled:cursor-not-allowed"
                style={{
            ...
            {/* ── Security note ── */}
            <div
              className="bg-white/20 backdrop-blur-xl rounded-2xl p-4 border border-white/30 s3-f4 relative z-10"
            >
